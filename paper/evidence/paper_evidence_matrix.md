...
| C3 | The 1% frozen safety margin succeeds at the exact selected time in 6/6 development conditions. | S0 exact-time v1.1 scoring and the frozen decision trace. | Development-set safety for gamma=1.01. | Not an independent-molecule or universal safety guarantee. | 218 |
| C4 | Safety and efficiency differ; total frozen-budget factors reach about 2.15 and 2.10 for the two HF stress cases. | Completion-analysis cost-factor decomposition. | safe != efficient under the continuous cost proxy. | C_star is the original two-PF saved-grid minimum, not a continuous-time global oracle. | 66 |
